...
inline cv::Mat tensor2mat(const torch::Tensor& tensor_in){
    ...
    //     channels.push_back( cv::Mat(tensor.size(2), tensor.size(3), cv_mat_type, red_output.data_ptr() ) );
    ...
    //     channels.push_back( cv::Mat(tensor.size(2), tensor.size(3), cv_mat_type, red_output.data_ptr() ) );
    //     channels.push_back( cv::Mat(tensor.size(2), tensor.size(3), cv_mat_type, green_output.data_ptr() ) );
    ...
    //     channels.push_back( cv::Mat(tensor.size(2), tensor.size(3), cv_mat_type, red_output.data_ptr() ) );
    //     channels.push_back( cv::Mat(tensor.size(2), tensor.size(3), cv_mat_type, green_output.data_ptr() ) );
    //     channels.push_back( cv::Mat(tensor.size(2), tensor.size(3), cv_mat_type, blue_output.data_ptr() ) );
